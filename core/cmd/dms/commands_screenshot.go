...
var ssWindowCmd = &cobra.Command{
	...
	Long:  `Capture the currently focused window. Supported on Hyprland, Mango, niri, and Aqueous. Aqueous requires a running CyShell shell and crops the output including borders and overlapping windows.`,
