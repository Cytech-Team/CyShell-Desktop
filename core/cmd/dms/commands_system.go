...
var systemCmd = &cobra.Command{
	...
	Long:  "System-level operations (updates, etc.). Runs against installed package managers directly; does not require the CyShell backend.",
}
...
func init() {
	...
	systemUpdateCmd.Flags().IntVar(&sysUpdateIntervalS, "interval", -1, "Set the CyShell backend poll interval in seconds and exit (requires running CyShell backend)")
