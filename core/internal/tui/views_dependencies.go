...
func (m Model) runPostInstallTasks() {
	if m.optionalDepSelected("dms-greeter") {
		m.reportProgress(0.92, "Configuring CyShell-compatible greeter...", "Starting automated greeter setup...")
		logLine := func(line string) {
			m.reportProgress(0.94, "Configuring CyShell-compatible greeter...", line)
		}
