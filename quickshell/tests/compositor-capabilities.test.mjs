...
test("display config and smart dock add aqueous while workspaces also support labwc", () => {
    expectSet("supportsDisplayConfig", ["niri", "hyprland", "mango", "aqueous"]);
    expectSet("supportsWorkspaces", ["niri", "hyprland", "mango", "labwc", "aqueous"]);
...
const CONVERTED = [
    ...
    ["Modules/Settings/WorkspaceAppearanceCard.qml", "supportsWorkspaces", "isNiri || isHyprland || isMango || isAqueous || isLabwc"],
    ...
    ["Modules/Settings/BarWidgetOptions/WorkspaceSwitcherOptions.qml", "supportsWorkspaces", "isNiri || isHyprland || isMango || isAqueous || isLabwc"],
