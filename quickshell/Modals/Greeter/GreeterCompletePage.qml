        ...
        Column {
            ...
            Column {
                ...
                Row {
                    ...
                    StyledText {
                        text: I18n.tr("CyShell Shortcuts", "greeter keybinds section header")
                        font.pixelSize: Theme.fontSizeMedium
                        font.weight: Theme.fontWeightMedium
                        color: Theme.surfaceText
                        anchors.verticalCenter: parent.verticalCenter
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        ...
                        StyledText {
                            text: I18n.tr("No CyShell shortcuts configured", "greeter no keybinds message")
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                            anchors.verticalCenter: parent.verticalCenter
                        }
            ...
            Column {
                ...
                Grid {
                    ...
                    GreeterSettingsCard {
                        width: (parent.width - Theme.spacingS) / 2
                        iconName: "toolbar"
                        title: I18n.tr("CyBar", "greeter settings link")
