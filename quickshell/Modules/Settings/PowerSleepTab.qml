    ...
    SettingsPage {
        ...
        SettingsCard {
            ...
            SettingsDropdownRow {
                ...
                options: [I18n.tr("Reboot"), I18n.tr("Log out"), I18n.tr("Power off"), I18n.tr("Lock"), I18n.tr("Suspend"), I18n.tr("Restart CyShell"), I18n.tr("Hibernate"), I18n.tr("Soft reboot")]
                currentValue: {
            ...
            Repeater {
                model: [
                    ...
                    {
                        key: "restart",
                        label: I18n.tr("Show restart CyShell")
                    },
                    {
                        key: "switchuser",
