...
RegistryBrowserWindow {
    ...
    function setThirdPartyVisible(show) {
        ...
        thirdPartyConfirm.showWithOptions({
            ...
            message: I18n.tr("Third-party plugins are created by the community and are not officially supported by CyShell.\n\nThese plugins may pose security and privacy risks - install at your own risk."),
    ...
    function checkPendingInstall() {
        ...
        installConfirm.showWithOptions({
            ...
            "message": I18n.tr("Install plugin '%1' from the plugin registry?", "plugin installation confirmation").arg(pluginId),
