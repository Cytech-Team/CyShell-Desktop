...
Column {
    ...
    SettingsCard {
        ...
        SettingsRow {
            ...
            subtitle: I18n.tr("Some plugins require a newer CyShell compatibility API:") + " " + root.incompatiblePlugins.map(plugin => plugin.name + " (" + plugin.requires_dms + ")").join(", ")
    ...
    DankCard {
        ...
        ColumnLayout {
            ...
            StyledText {
                Layout.fillWidth: true
                text: I18n.tr("Extend CyShell with powerful plugins for widgets, launchers, and more")
