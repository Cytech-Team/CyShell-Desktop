    ...
    SettingsPage {
        ...
        SettingsCard {
            ...
            SettingsRow {
                body: StyledText {
                    width: parent.width
                    text: I18n.tr("Rules found in your compositor config. These are read-only here, use Convert to CyShell to make an editable copy.")
                    font.pixelSize: Theme.fontSizeSmall
                    color: Theme.surfaceVariantText
            ...
            Repeater {
                ...
                delegate: SettingsRow {
                    ...
                    DankActionButton {
                        ...
                        opacity: enabled ? 1 : 0.5
                        anchors.verticalCenter: parent.verticalCenter
                        tooltipText: I18n.tr("Convert to CyShell")
                        tooltipSide: "left"
