...
SettingsCard {
    ...
    SettingsRow {
        visible: !root.cursor
        subtitle: I18n.tr("CyShell uses the font family, weight and scale. Exact face, slant, width and separately scaled bars may differ.", "Aqueous font synchronization, describing which font settings DMS can represent")
    }
