...
RegistryBrowserWindow {
    ...
    function checkPendingInstall() {
        ...
        installConfirm.showWithOptions({
            ...
            "message": I18n.tr("Install theme '%1' from the theme registry?", "theme installation confirmation").arg(themeId),
    ...
    aboveSearch: [
        StyledText {
            ...
            text: I18n.tr("Install color themes from the theme registry", "theme browser description")
