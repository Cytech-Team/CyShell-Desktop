            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: I18n.tr("To use this CyShell bind, remove or change the keybind in your config.kdl")
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceVariantText
                            width: parent.width
                            wrapMode: Text.WordWrap
                ...
                RowLayout {
                    ...
                    Flow {
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: I18n.tr("On release", "labwc keybind option, run when the shortcut is released")
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.surfaceVariantText
                            }
                        }
