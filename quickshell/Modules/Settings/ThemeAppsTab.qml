...
Item {
    ...
    SettingsPage {
        ...
        SettingsCard {
            ...
            SettingsToggleRow {
                enabled: neovimThemeToggle.visible && neovimThemeToggle.checked
                text: I18n.tr("Follow CyShell background color")
                tags: ["matugen", "neovim", "terminal", "template"]
            ...
            SettingsToggleRow {
                ...
                text: "VS Code"
                description: root.getTemplateDescription("vscode", I18n.tr("Requires the CyShell-compatible Theme extension from the editor marketplace", "vscode matugen template description"))
