    ...
    SettingsPage {
        ...
        SettingsCard {
            ...
            SettingsToggleRow {
                ...
                description: I18n.tr("Adds them to the %1 group so they can run cyshell-greeter sync --profile", "create user greeter toggle description, %1 is a group name").arg(UsersService.greeterGroup)
