...
Item {
    ...
    readonly property real widgetSpacing: (segmented ? BarMetrics.segmentGap : noBackground ? BarMetrics.bareGap : widgetStyle === "taskbar" ? BarMetrics.taskbarGap : BarMetrics.pillGap) + outlineThickness * 2
