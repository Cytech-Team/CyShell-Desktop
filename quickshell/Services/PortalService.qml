...
Singleton {
    ...
    function setSystemProfileImage(imagePath) {
        ...
        DMSService.sendRequest("freedesktop.accounts.setIconFile", {
            ...
            if (response.error) {
                ...
                Quickshell.execDetached(["notify-send", "-u", "normal", "-a", "CyShell", "-i", "error", I18n.tr("Profile Image Error"), userMessage]);
    ...
    function checkDMSCapabilities() {
        ...
        if (freedeskAvailable) {
            ...
            log.info("freedesktop capability not available in CyShell");
        }
    }
