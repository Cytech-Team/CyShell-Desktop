...
Singleton {
    ...
    function sendTestNotification(index) {
        const notifications = [["Notification Position Test", "CyShell test notification 1 of 3 ~ Hi there!", "preferences-system"], ["Second Test", "CyShell Notification 2 of 3 ~ Check it out!", "applications-graphics"], ["Third Test", "CyShell notification 3 of 3 ~ Enjoy!", "face-smile"]];
