...
Singleton {
    ...
    property var greeterAutoLoginSyncProcess: Process {
        command: ["cyshell-greeter", "sync", "--yes", "--autologin"]
        running: false
    ...
    property var greeterAutoLoginSyncSudoProbeProcess: Process {
        ...
        onExited: exitCode => {
            ...
            if (exitCode === 0) {
                root.toastRequested(1, enabling ? I18n.tr("Applying auto-login on startup...") : I18n.tr("Disabling auto-login on startup..."), "", "cyshell-greeter sync --autologin", "greeter-autologin-sync");
